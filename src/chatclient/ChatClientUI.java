...
public class ChatClientUI extends javax.swing.JFrame {
    ...
    public ChatClientUI() throws RemoteException {
        initComponents();
        chatClientImpl = new ChatClientImpl(this);
    }
    ...
    private void connectActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_connectActionPerformed
        if (connectionButton.getText().equals("Connect")) {
            ...
            try {
                chatClientImpl.connect(username);
            ...
            try {
                chatClientImpl.disconnect(username);
            } catch (RemoteException ex) {
                Logger.getLogger(ChatClientUI.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void sendActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_sendActionPerformed
        ...
        try {
            chatClientImpl.sendMessage(username, message);
        } catch (RemoteException ex) {
            Logger.getLogger(ChatClientUI.class.getName()).log(Level.SEVERE, null, ex);
        }
        inputText.setText("");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ChatClientUI.class
