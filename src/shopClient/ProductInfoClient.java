...
public class ProductInfoClient extends javax.swing.JFrame {
    ...
    private void searchButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchButtonActionPerformed
        ...
        try {
            ...
            ProductInfo prod = (ProductInfo) Naming.lookup("//localhost/ProductInfoImpl");
            switch(productCat){
                case BOOK: 
                    productList = prod.findBooks(searchString);
                case FILM: 
                    productList = prod.findFilms(searchString);
                case ALL:
                    productList = prod.findProducts(searchString);
            }
        ...
        productModel.fireTableDataChanged();
            ...
            System.out.println("Error occured in Product Info CLient "  + ex);
